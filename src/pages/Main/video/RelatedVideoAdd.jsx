...
//       formData.append('video_resource',  );
...
export default function RelatedVideoAdd() {
  ...
  // Handle file input change for PDF/DOCX/DOC
  ...
  // Handle drag-over event for video
  const handleVideoDraggingOver = (e) => {
    e.preventDefault();
    setIsDraggingVideo(true);
  };

  // Handle drag-leave event for video
  ...
  // Handle drag-over event for PDF/DOCX/DOC
  const handlePdfDraggingOver = (e) => {
    e.preventDefault();
    setIsDraggingPdf(true);
  };

  // Handle drag-leave event for PDF/DOCX/DOC
  const handlePdfDraggingLeave = (e) => {
    e.preventDefault();
    setIsDraggingPdf(false);
  };

  // Handle drop event for PDF/DOCX/DOC
